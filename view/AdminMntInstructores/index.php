...
if (isset($_SESSION["usuario_id"])) {?>
    ...
    <html lang="es">
        ...
        <body>
            ...
            <div class="br-mainpanel">
                <div class="br-pageheader pd-y-15 pd-l-20">
                    <nav class="breadcrumb pd-0 mg-0 tx-12">
                        ...
                        <a class="breadcrumb-item" href="http://certificados-php.test/view/AdminMntInstructores/">Mantenimiento</a>
                        <span class="breadcrumb-item active">Instructores</span>
                    </nav>
                </div>
                <div class="pd-30">
                    <h4 class="tx-gray-800 mg-b-5">Mantenimiento de Instructores</h4>
                    <p class="mg-b-0">Página para mostrar toda la información de los Instructores.</p>
                </div><!-- d-flex -->                
                ...
                <div class="br-pagebody">
                    ...
                    <div class="card bd-0 shadow-base pd-30 mg-t-20">
                        ...
                        <div class="table-wrapper">
                            <table id="tbl_instructores" class="display responsive nowrap" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>NOMBRE</th>
                                        <th>EMAIL</th>
            ...
            <!-- ########## END: MAIN PANEL ########## -->
            <?php require_once 'modalmntinstructor.php'; ?>
